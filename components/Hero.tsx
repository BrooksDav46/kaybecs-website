      ...
      <div className="relative h-[600px] w-full sm:h-[640px] md:h-[700px] xl:h-[760px]">
        ...
        >
          <div className="w-full max-w-[650px]">
            ...
            <motion.p
              variants={fadeUp}
              className="mt-5 text-[17px] leading-[1.6] text-white/90 sm:text-[18px] md:mt-6 md:text-[22px]"
            >
            ...
            >
              <Link
                href="tel:9152742685"
                className="inline-flex w-full items-center justify-center rounded-xl bg-sky-500 px-6 py-4 text-base font-black text-white transition hover:-translate-y-0.5 hover:bg-sky-400 sm:w-auto md:min-w-[220px] md:text-xl"
              >
              ...
              <Link
                href="/#contact"
                className="inline-flex w-full items-center justify-center rounded-xl bg-white px-6 py-4 text-base font-black text-[#0A4CB3] transition hover:-translate-y-0.5 hover:bg-slate-100 sm:w-auto md:min-w-[270px] md:text-xl"
              >
                Request Estimate
